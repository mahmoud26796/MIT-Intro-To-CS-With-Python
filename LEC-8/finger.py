...
print(same_chars("xyz", "zyx"))      # prints True
print(same_chars("moon", "nomo"))    # prints True
print(same_chars("hello", "heloz"))  # prints False
print(same_chars("test", "tsetx"))   # prints False